...
' Static Friend objects in that anything not declared within the classes will not be exposed
' to in the DLL interface (though within this project we can see them just fine -- as we of
